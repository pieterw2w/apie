...
class ClassResourceConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->testItem = new ClassResourceConverter(
            ...
            new ApiResources([ApiResources\App::class, ApiResources\Status::class, SimplePopo::class, RecursiveObject::class]),
            true
        );
    }
    ...
    {
        $this->assertEquals('app', $this->testItem->normalize(ApiResources\App::class));
    ...
    {
        $this->assertEquals(ApiResources\App::class, $this->testItem->denormalize('app'));
